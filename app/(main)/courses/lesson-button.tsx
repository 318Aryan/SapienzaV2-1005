...
export const LessonButton = ({
  ...
  // Always target this lesson's own id — the current/in-progress lesson
  // used to fall back to the parameterless "/lesson" shortcut, which
  // doesn't exist as a route; the id is already known here, so there's
  // no reason to rely on that indirection at all.
